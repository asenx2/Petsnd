 ...
 */
//Clase adaptador para el recycler view de las publicaciones favoritas guardadas en sharedpreferences
//Se muestra la imagen más grande y el título de la publicación
class AdapterFavoritas(val context: Context,
                       val layout: Int,
                       val dataList: ArrayList<Publicacion>
) : RecyclerView.Adapter<AdapterFavoritas.ViewHolder>() {
